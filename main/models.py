...
class Blog(models.Model):
    ...
    title = models.CharField(max_length=100, blank=True,null=True)
    _type = models.CharField(max_length=100 , blank=True , null=True , choices = types)
    cover = models.CharField(max_length=5048,blank=True,null=True )
    bg = models.CharField(max_length=5048,blank=True,null=True )
    created_at = models.DateField(auto_now=True)

    body = models.TextField(max_length=100000 , blank=True ,null=True)
